    ...
    try {
      ...
      try {
        ...
        if (interviewer && selectedDate && user) {
          const confirmationEmail = EmailService.generateInterviewConfirmationEmail(user.name, user.email, {
          ...
          const emailResult = await EmailService.sendEmail(confirmationEmail)
